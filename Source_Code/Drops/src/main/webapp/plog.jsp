...
<div class="login">
<div class="H3 text-center">PROXY LOGIN</DIV><br>
<form action="plog1.jsp" name="ds" onsubmit="">
...
<br>
<input type="submit" value="LOGIN" class="btn btn-primary btn-block btn-responsive">
</form>
</div>
</div>
<div class="col-md-4">
